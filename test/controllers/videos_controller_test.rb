...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference('Video.count') do
      post videos_url, params: { video: { description: @video.description, name: @video.name } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { description: @video.description, name: @video.name } }
